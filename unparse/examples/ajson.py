...
from ..combinators import (many0,   optional,   plus,     node,
                           seq2R,   many1,      all_,     any_,   error,
                           seq2L,   position,   sepBy0,   not0,   cut)
...
# the error message for `close` is wrong:  example -- `{"ab":3, }` is reported incorrectly
# although, resonably, the blame for this problem could be laid on the key/value parser:
# it should detect that there's a trailing comma and report that
